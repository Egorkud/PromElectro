...
class DataScrappers(Resources):
    ...
    def big_scrap_from_articules(self, filename : str = "scrapped_data (name).xlsx"):
        char_dict = {}
        counter = 43

        for row in range(15, self.work_sheet.max_row + 1):
            print(self.GREEN(f"{row}. Started"))

            url_search_ru = "https://feron.ua/search/?search="
            url_search_ukr = "https://feron.ua/ua/search/?search="
            ...
            try:
                ...
                try:
                    ...
                    #         if instruction.find("span").text == "Инструкция":
